  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        heading: ["var(--font-heading)", "Black Han Sans", "Noto Sans KR", "sans-serif"],
        display: ["var(--font-heading)", "Black Han Sans", "Noto Sans KR", "sans-serif"],
        label: ["var(--font-label)", "Bebas Neue", "Noto Sans KR", "sans-serif"],
      },
    },
  },
  plugins: [],
